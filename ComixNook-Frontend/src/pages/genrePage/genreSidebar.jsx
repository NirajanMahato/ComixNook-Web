...
const GenreSidebar = ({filterItem, genreList}) =>{
    ...
    return(
        <>
            <div className="md:pl-8 md:py-3 md:border-r-2 w-[17%] flex flex-col">
                ...
                <div className="w-full flex md:flex-col md:gap-2 gap-4 flex-row items-start pt-4">
                    {genreList.map((curElem) => (
                        <button
                            key={curElem}
                            className="border-b-2 border-transparent text-gray-700 focus:border-black focus:text-black"
